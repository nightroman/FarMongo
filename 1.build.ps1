...
task package version, {
	...
	Copy-Item -Destination z\$_name\Scripts -Path $(
		'Scripts\*'
	)

	Copy-Item -Destination z\$_name -LiteralPath $(
...
task test {
	exec { pwsf "$env:FarNetCode\Test\Panels.Mongo" -nop -x 999 -c Test-FarNet.ps1 }
}
